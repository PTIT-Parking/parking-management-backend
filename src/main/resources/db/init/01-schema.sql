...
CREATE TABLE
  IF NOT EXISTS `parking_card` (`card_id` int NOT NULL, PRIMARY KEY (`card_id`)) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;

CREATE TABLE
  IF NOT EXISTS `vehicle_type` (
...
CREATE TABLE
  IF NOT EXISTS `student_information` (
    `customer_id` varchar(36) NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS `lecturer_information` (
    `customer_id` varchar(36) NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS `active_monthly_registration` (
    `id` varchar(36) NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS `expire_monthly_registration` (
    `id` varchar(36) NOT NULL,
    `expiration_date` datetime (6) NOT NULL,
    `issue_date` datetime (6) NOT NULL,
    `create_by` varchar(36) NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS `parking_record_history` (
